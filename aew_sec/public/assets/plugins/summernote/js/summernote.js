...
(function (factory) {
  ...
  var Renderer = function () {
               ...
               '<div class="modal-dialog">' +
                 '<div class="modal-content">' +
                   ...
                   '<div class="modal-header">' +
                     ...
                     '<h3 class="modal-title menu-cinza headline"><b>' + title + '</b></h3>' +
                   '</div>' : ''
                   ) +
    ...
    var tplShortcut = function (title, keys) {
      ...
      return '<div class="note-shortcut-row"><div class="' + keyClass + 'title col-xs-offset-6">' + title + '</div></div>' +
             '<div class="note-shortcut-row">' + body.join('</div><div class="note-shortcut-row">') + '</div>';
    };
    ...
    var tplShortcutTable = function (lang, options) {
      ...
      return '<div class="note-shortcut-row">' +
               template.join('</div><div class="note-shortcut-row">') +
             '</div>';
    };
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      var $editable = $('<div class="note-editable" contentEditable="' + isContentEditable + '"></div>').prependTo($editingArea);
