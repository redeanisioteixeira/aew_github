                        ...
                        <figure class="col-lg-12">
                            <div class="row">
                                <a href="<?php echo $conteudo->getLinkPerfil();?>">
                                    <img class="img-circle img-responsive cor-canal-fundo margin-auto shadow-center" src="/assets/img/icones/<?php echo $conteudo->getFormato()->getConteudoTipo()->getIconeTipo('png')?>.png" width="50%">
                                </a>
                            </div>
                        </figure>
                    ...
                    <div class="col-lg-9 col-md-9 col-sd-9 margin-top-10">
                        <div class="row">
                            ...
                            <div class="text-justify">
                                <?php echo $this->readMore($conteudo->getDescricao(), 400);?>
                            </div>
