				...
				<?php foreach($this->disciplinas as $disciplina):?>
				    ...
				    <?php if($disciplina->getId() != 31):?>
						...
						<li class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						    <figure class="height-180 site-tematico-opcao site-tematico<?php echo $disciplina->getId();?> arrow-left right">
						        <a class="site-tematico<?php echo ($i == 1 ? " active":"");?>" site="<?php echo $disciplina->getId().($disciplina->getId() == 38 ? ",31" : "");?>" posicao="<?php echo $i;?>" area="<?php echo $j;?>" controller="<?php echo $this->getController();?>">
						            <img class="desativado site-tematico trans90 shadow-center cor-canal-fundo img-rounded img-responsive margin-auto" src="/assets/img/icones_disciplinas/icone_disciplina<?php echo $disciplina->getId();?>.png"/>
									<h5 class="menu-vermelho text-center margin-all-05"><b><?php echo $disciplina->getNome().($disciplina->getId() == 38 ? " e Literatura" : "");?></b></h5>
						        </a>
						    </figure>
						</li>
