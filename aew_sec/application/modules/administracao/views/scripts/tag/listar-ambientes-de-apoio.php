            ...
            <?php foreach($this->tags as $tag):?>
                ...
                <?php if($letraPrimeira):?>
                    <?php if($alfabeto != $letraPrimeira):?>
                            ...
                            <div class="col-lg-4">
                            <h3 class="menu-amarelo page-header"><b><?php echo $letraPrimeira;?></b></h3>
                    ...
                    <li class="comma">
                        <?php if(isset($this->href['editar_tag'])):?>
                            <a class="link-cinza-escuro" href="/ambientes-de-apoio/ambientes/tags/id/<?php echo $tag->getId();?>"><?php echo trim($this->escape($tag->getNome()));?></a>
                        <?php else:?>
