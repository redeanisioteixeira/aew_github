<?php
class Sec_Filter_Xss implements Zend_Filter_Interface
{
    /**
     * Defined by Zend_Filter_Interface
     *
     * Returns the string $value, cleaning XSS
     *
     * @param  string $value
     * @return string
     */
    public function filter($value)
    {
        ...
        $tags = array("plaintext");
        $filter = new InputFilter($tags, null, 1, 1, 1);
...
class InputFilter {
	...
	protected $tagBlacklist = array('applet', 'body', 'bgsound', 'base', 'basefont', 'embed', 'frame', 'frameset', 'head', 'html', 'id', 'iframeold', 'ilayer', 'layer', 'link', 'meta', 'name', 'object', 'script', 'style', 'title', 'xml', 'p');
